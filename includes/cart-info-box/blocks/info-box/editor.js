		...
		edit: function() {
			...
			if ( ServerSideRender ) {
				preview = el( ServerSideRender, {
					...
					EmptyResponsePlaceholder: function() {
						return el(
							...
							__( 'Warenkorb Info-Box ist deaktiviert oder leer. Konfiguriere sie unter WooCommerce → Warenkorb Info-Box.', 'woo-cart-info-box' )
						);
					}
				} );
			} else {
				preview = el(
					...
					__( 'Warenkorb Info-Box (Vorschau im Frontend sichtbar)', 'woo-cart-info-box' )
				);
			}
